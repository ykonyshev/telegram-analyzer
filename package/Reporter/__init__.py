...
from package.ClientPool import ClientPool
from package.logging import get_logger
from package.models.Chat import Chat
from package.Reporter.ChatHandler import ChatHandler
from package.utils.LoggerTimer import LoggerTimer
...
class Reporter:
    def __init__(
        ...
        analyzer_classes: list[Type[BaseAnalyzer]] = list(),
        ...
        self._base_analyzers: list[Type[BaseAnalyzer]] = analyzer_classes
